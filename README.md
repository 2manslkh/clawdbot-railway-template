...
- On Railway, setting the `OPENCLAW_GIT_REF` service variable overrides the Dockerfile default at build time.
- `OPENCLAW_GIT_REF` may be a tag, branch, or commit SHA.
